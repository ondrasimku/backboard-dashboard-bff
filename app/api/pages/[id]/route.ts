...
export async function GET(
  ...
  try {
    ...
    const response = await fetch(`${pagesServiceUrl}/api/pages/${id}`, {
      headers: {
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        { error: error.error || error.message || 'Failed to fetch page', code: error.code },
...
export async function PATCH(
  ...
  try {
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        { error: error.error || error.message || 'Failed to update page', code: error.code },
        { status: response.status }
      );
    }
...
export async function DELETE(
  ...
  try {
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        { error: error.error || error.message || 'Failed to delete page', code: error.code },
        { status: response.status }
      );
    }
